...
namespace EasyGold.Web2.Models.Comune.GEO.Localita
{
    public class LocalitaLangDTO
    {
        ...
        [SwaggerSchema(Description = "È il nome della Località tradotto nella lingua della Nazione di cui al codice ISO.")]
        [StringLength(200)]
