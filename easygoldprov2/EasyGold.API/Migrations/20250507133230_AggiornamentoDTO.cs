...
namespace EasyGold.API.Migrations
{
    ...
    public partial class AggiornamentoDTO : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Sys_IDAuto = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Sys_Sezione = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Sys_IDNazione = table.Column<int>(type: "int", nullable: true),
                    Sys_NomeCampo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Sys_TipoCampo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Sys_Valore = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Sys_Lunghezza = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "syscl_configLang",
                columns: table => new
                {
                    SysLng_ISONum = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SysLng_ID = table.Column<int>(type: "int", nullable: false),
                    SysLng_NomeCampo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_syscl_configLang", x => x.SysLng_ISONum);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Ntn_ISO1 = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Ntn_Descrizione = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
