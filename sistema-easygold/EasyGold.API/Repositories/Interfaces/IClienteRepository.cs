...
namespace EasyGold.API.Repositories.Interfaces
{
    public interface IClienteRepository
    {
        ...
        Task<(DbCliente Cliente, DbDatiCliente? DatiCliente, List<Tuple<DbModuloEasygold, DbModuloCliente>>? Moduli, List<DbAllegato>? Allegati, List<DbNegozi>? Negozi, DbNazioni? Nazione, DbValute? Valuta, DbStatoCliente? StatoCliente)>
        GetClienteByIdAsync(int id);

        Task<(IEnumerable<(DbCliente Cliente, DbDatiCliente? DatiCliente, List<Tuple<DbModuloEasygold, DbModuloCliente>>? Moduli, List<DbAllegato>? Allegati, List<DbNegozi>? Negozi, DbNazioni? Nazione, DbValute? Valuta, DbStatoCliente? StatoCliente)> Clienti, int Total)>
